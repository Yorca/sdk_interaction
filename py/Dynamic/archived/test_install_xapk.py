...
path_list = ["/Users/yorca/Downloads/test"]  # ["/Volumes/Yorca_T7/apks_new"]  ["/Volumes/YorcaDisk/class_apks"]   ["/Users/yorca/projects/sdk_interaction/testing_app/APKs"]
...
for path in path_list:
    try:
        for filename in os.listdir(path):
            ...
            installApk(device_file_path,path,pkg_name, file_path)
