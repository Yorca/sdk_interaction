...
def start_app(package_name):
    try:
        ...
        script.on('message', on_message)onAccessibilityEvent
        script.load()
        device.resume(pid)
        time.sleep(40)
        session.detach()
...
if __name__ == '__main__':
    ...
    path_list = ["/Volumes/Yorca_T7/apks_new"]#["/Volumes/Yorca_T7/apks_new"]  ["/Volumes/YorcaDisk/class_apks"]   ["/Users/yorca/projects/sdk_interaction/testing_app/APKs"]
