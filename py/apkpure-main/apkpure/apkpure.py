...
class ApkPure:
    ...
    def extract_info_from_search(self, html_element):
        ...
        def get_package_data() -> dict:
            ...
            print("html_element" + str(html_element))

            package_data = html_element.find("a", class_="first-info")
        ...
        def get_download_link() -> dict:
            if download_link := html_element.find("a", class_="first-info"):
                print("download_link" + str(download_link.attrs.get("href", "Unknown")))
                return {"download_link": download_link.attrs.get("href", "Unknown") + "/download?"}
...
apkp = ApkPure()
apkp.download("com.stuzo.chevron")